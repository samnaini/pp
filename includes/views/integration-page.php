...
?>
<script>
  const pp_integration_switch_nonce = "<?php echo wp_create_nonce( 'pp-integration-switch' ) ?>"
</script>
<template id="pp-app">
  <div id="pp-integration" class="pp-wrap">
    ...
    <h2><?php esc_html_e( 'Integration', 'parcelpanel' ) ?><svg style="margin-left:8px" width="36" height="20" viewBox="0 0 36 20" fill="none" xmlns="http://www.w3.org/2000/svg"><rect width="36" height="20" rx="4" fill="#F36A5A"/><path d="M7.76758 14L7.76758 8.53613H7.8457L11.6689 14H12.5234V6.9541H11.6543V12.4375H11.5762L7.75293 6.9541H6.89844L6.89844 14H7.76758ZM18.6855 13.209H15.1992V10.7871H18.5049V10.0059H15.1992V7.74512H18.6855V6.9541H14.3203V14H18.6855V13.209ZM24.1885 8.43848H24.2471L25.8682 14H26.6982L28.6172 6.9541H27.6992L26.2979 12.6816H26.2393L24.6621 6.9541H23.7734L22.1963 12.6816H22.1377L20.7363 6.9541H19.8184L21.7373 14L22.5674 14L24.1885 8.43848Z" fill="white"/></svg></h2>
