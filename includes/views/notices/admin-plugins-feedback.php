...
?>
<script>
    const pp_feedback_confirm_nonce = "<?php echo wp_create_nonce('pp-feedback-confirm')?>"
...
<style>
    ...
    .pp-rate i:hover::after, .pp-rate i:hover ~ i::after {
        content: "\f155"
    }
...
<div class="notice notice-info notice-alt is-dismissible parcelpanel-message" id="pp-notice-plugins_feedback">
    ...
    <p><?php echo sprintf(esc_html__('Hi there! Your feedback means a lot to us! Take a minute to share your experience with %1$sParcelPanel Order Tracking for WooCommerce%2$s will inspire us to keep going.', 'parcelpanel'), '<b>', '</b>') ?> </p>
    <div class="pp-rate"><i data-value="5"></i><i data-value="4"></i><i data-value="3"></i><i data-value="2"></i><i
            data-value="1"></i></div>
    <a href="<?php echo esc_url($url_dismiss) ?>" class="notice-dismiss" style="text-decoration:none"><span
            class="screen-reader-text"><?php esc_html_e('Dismiss this notice.', 'parcelpanel') ?></span></a>
</div>
        ...
        <div role="document" class="components-modal__content" style="display:flex; flex-direction: column;">
            <div class="components-modal__header">
                <div class="components-modal__header-heading-container"><h1
                        class="components-modal__header-heading"><?php esc_html_e('Send your feedback', 'parcelpanel') ?></h1>
                </div>
            ...
            <div class="pp-modal-body">
                ...
                <textarea id="pp-modal-feedback__msg" placeholder="Edit your message here..."
                          style="display:block;width:100%;border-radius:2px" rows=6></textarea>
                <p style="margin:8px 0 4px"><?php esc_html_e('Your contact email', 'parcelpanel') ?></p>
                <input id="pp-modal-feedback__email" type="text" placeholder="e.g. parcelpanel100@gmail.com"
                       value="<?php echo esc_attr($current_user->user_email) ?>" class="components-placeholder__input"
                       style="width:100%;margin:0;height:36px;border-radius:2px;">
            </div>
        </div>
