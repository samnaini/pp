...
?>
<script>
  const pp_tracking_page_save_nonce = "<?php echo wp_create_nonce( 'pp-tracking-page-save' ) ?>";
</script>
...
<template id="pp-app">
  <div id="pp-tracking-page" class="pp-wrap">
    ...
    <div style="width:300px">
      <div><h2><?php esc_html_e( 'Tracking Page', 'parcelpanel' ) ?></h2></div>
    </div>
    ...
    <div class="pp-card pp-m-t-5">
      <panel-toggle title="<?php esc_html_e( 'Display options', 'parcelpanel' ) ?>">
        ...
        <div class="pp-taggle">
          ...
          <!--Google translate widget-->
          <!-- <div class="pp-row pp-m-t-5">
            <div class="pp-col-xs-3 pp-taggle-input pp-taggle-body-min-wdith">
              <label class="pp-label">Google translate widget</label>
            </div>
            <div class="pp-col-xs-9 pp-taggle-body-min-wdith pp-taggle-input">
              <checkbox-control label="你好世界" class="pp-m-r-4"></checkbox-control>
              <checkbox-control label="你好世界" class="pp-m-r-4"></checkbox-control>
              <checkbox-control label="你好世界" class="pp-m-r-4"></checkbox-control>

              <span class="components-checkbox-control__input-container">
                <input id="inspector-checkbox-control" type="checkbox" class="components-checkbox-control__input"/> -->
        ...
        <label class="components-checkbox-control__label" for="inspector-checkbox-control">在博客中置顶</label>
      </div>
    </div> -->
          ...
          <!--Button-->
          <!-- <div class="pp-row pp-m-t-5">
            <div class="pp-col-xs-12 pp-col-sm-12 pp-col-md-3 pp-col-lg-3  pp-taggle-input pp-taggle-body-min-wdith">
              <label class="pp-label">testButtonComponent</label>
            </div>
            <div class="pp-col-xs-9 pp-taggle-body-min-wdith">
              <pp-button id="1" style="width: 60px; height: 36px"/>
            </div>
          </div> -->
          <!-- switch -->
          <!-- <div class="pp-row pp-m-t-5">
            <div class="pp-col-xs-12 pp-col-sm-12 pp-col-md-3 pp-col-lg-3  pp-taggle-input pp-taggle-body-min-wdith">
              <label class="pp-label">switch</label>
            </div>
            <div class="pp-col-xs-9 pp-taggle-input pp-taggle-body-min-wdith" display="display:  flex-direction: column;"> -->
          <!-- // change返回开关是否为开 需要函数接收 -->
          <!-- <toggle-control @change=""></toggle-control>
        </div>
      </div> -->
        </div>
      </panel-toggle>
            ...
            <div class="pp-row" type="flex">
              ...
              <div class="pp-col-xs-12 pp-col-md-8">
                <div class="pp-order-status">
                  ...
                  <div class="pp-m-l-3"><p><?php esc_html_e( 'Ordered', 'parcelpanel' ) ?></p></div>
                </div>

                <div v-show="isEmpty" class="pp-order-status" style=" justify-content: center; background: #FFFFFF;">
                  <div class="pp-m-l-3"><p><?php esc_html_e( 'Create additional steps to inform customers of your process prior to shipping', 'parcelpanel' ) ?></p></div>
                </div>
                ...
                <div class="pp-order-status ">
                  ...
                  <div class="pp-m-l-3"><p><?php esc_html_e( 'Order ready', 'parcelpanel' ) ?></p></div>
                </div>
                <div class="pp-order-status">
                  <div class="pp-m-l-4">
                    <svg style="height: 20px;width: 20px;" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20">
                  ...
                  <div class="pp-m-l-3"><p><?php esc_html_e( 'In transit', 'parcelpanel' ) ?></p></div>
                </div>
                <div class="pp-order-status ">
                  <div class="pp-m-l-4">
                    <svg style="height: 20px;width: 20px;" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20">
                  ...
                  <div class="pp-m-l-3"><p><?php esc_html_e( 'Out for delivery', 'parcelpanel' ) ?></p></div>
                </div>
                <div class="pp-order-status ">
                  <div class="pp-m-l-4">
                    <svg style="height: 20px;width: 20px;" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20">
                  ...
                  <div class="pp-m-l-3"><p><?php esc_html_e( 'Delivered' ); ?></p></div>
                </div>
              </div>
            </div>
          ...
          <div class="pp-row" type="flex">
            <div class="pp-col-xs-12 pp-col-md-4  pp-p-r-5 pp-taggle-body-min-wdith">
              ...
              <p>
                  ...
                  <?php echo sprintf( esc_html__( '%1$sAdd category%2$s in your WordPress Products section to recommend.', 'parcelpanel' ), '<a href="' . esc_url( admin_url( 'edit-tags.php?taxonomy=product_cat&post_type=product' ) ) . '" target="_blank">', '</a>' ) ?>
              </p>
    ...
    <div class="pp-card">
      <panel-toggle title="<?php esc_html_e( 'Manually translate tracking detailed info', 'parcelpanel' ) ?>">
        <div class="pp-taggle">
          <div><p><?php esc_html_e( 'Here you can manually translate the tracking detailed info by yourself.', 'parcelpanel' ) ?></p></div>
          <div><p><?php esc_html_e( 'Note: this feature distinguishes the strings based on Space, please don\'t forget the comma and period when you do the translation.', 'parcelpanel' ) ?></p></div>
        ...
        <div class="pp-taggle">
          <div class="pp-row" type="flex">
            <div class="pp-col-xs-12 pp-col-md-4 pp-p-r-5 pp-taggle-body-min-wdith">
              ...
              <p><?php
                  echo sprintf( esc_html__( 'View the CSS codes here you used to do the custom change of your tracking page, if you would like to change codes, please %1$scontact us%2$s or follow %3$sthis instruction%4$s.', 'parcelpanel' )
                      , '<a @click="onContactUs" href="javascript:">', '</a>'
                      , '<a href="https://docs.parcelpanel.com/woocommerce/article/customize-your-tracking-page-via-css-codes/" target="_blank">', '</a>' )
                  ?></p>
            </div>
            <div class="pp-col-xs-12 pp-col-md-8 pp-taggle-body-min-wdith">
